...
* **Infrastructure:** Migrated to **Cloudflare** via **Beget** for global accessibility, DNS optimization, and 100% cross-device visibility.
...
* **Инфраструктура:** Настройка DNS и проксирования через **Cloudflare** (регистратор **Beget**) для стабильной работы сайта по всему миру.
* **Стек:** **React 19**, **Tailwind CSS 4.0**, **Supabase**, **Edge Functions**.
* **Рабочий процесс:** Разработано с использованием **Claude Code** для быстрого прототипирования.
...
* **Технологии:** Python (aiogram), гибридный ИИ (Groq Whisper V3 + Llama 3.3 + **Gemini**).
